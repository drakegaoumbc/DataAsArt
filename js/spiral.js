    ...
    svg.selectAll("rect")
      ...
      .style("fill", function(d){if(d.degree == "veryhigh"){ return '#0B6AD5' } 
        ...
        else if(d.degree == "medium") {return "#FFD916"} 
        else if(d.degree == "low") {return "#FF9102"} 
        else {return '#D5005D'}})
      .style("stroke", "none")
    ...
    .on('mouseover', function(d) {
        ...
        tooltip.select('.value').html("Life Expectancy: <b>" + d.value*5 + "<b>");
...
/*var width = 500,
    ...
    .on('mouseover', function(d) {
        ...
        tooltip2.select('.value').html("Life Expectancy: <b>" + d.value*5 + "<b>");
...
var degrees = ["low","medium","medium","medium","medium","medium","medium","medium","medium","medium","medium","medium","medium","medium","medium","medium","medium","medium","medium","medium","medium","medium","medium","medium","medium","medium","medium","medium","medium","medium","medium","medium","medium","medium","medium","medium","medium","medium","medium","medium","medium","medium","medium","medium","medium","medium","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high","high", "high"]
